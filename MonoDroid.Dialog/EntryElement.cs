	...
	public class EntryElement : Element, ITextWatcher
	{
        ...
        public override View GetView(Context context, View convertView, ViewGroup parent)
		{
            ...
            if (view != null)
            {
                ...
                if (this.Password)
                    _entry.InputType = (InputTypes)(InputTypes.ClassText | InputTypes.TextVariationPassword);
                else if (this.Numeric)
                    _entry.InputType = (InputTypes)(InputTypes.ClassNumber | InputTypes.NumberFlagDecimal | InputTypes.NumberFlagSigned);
                else
                    _entry.InputType = (InputTypes)InputTypes.ClassText;
